...
//permitir 50 caracteres en el título del evento
addEventTitle.addEventListener("input", (e) => {
  addEventTitle.value = addEventTitle.value.slice(0, 60);
});

//permitir sólo tiempo en eventtime desde y hacia
...
addEventSubmit.addEventListener("click", () => {
  ...
  //comprobar el formato de hora correcto 24 horas
...
eventsContainer.addEventListener("click", (e) => {
  if (e.target.classList.contains("event")) {
    swal.fire({
      title: '¿Estás seguro?',
      text: '¿Deseas Finalizar el Evento?',
      icon: 'question',
      ...
      eventsArr.forEach((event) => {
        if (
          ...
          event.events.forEach((item, index) => {
            ...
            //imprimir el sweet alert
            swal.fire({
              title: 'Evento Finalizado',
              text: 'El evento ha sido finalizado',
              icon: 'success',
