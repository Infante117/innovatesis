    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li class="dropdown"><a class="active"><span>Acerca de</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        <li><a href="<?php echo APP_URL; ?>about/">Sobre nosotros</a></li>
                        <li><a href="<?php echo APP_URL; ?>team/">Equipo</a></li>
                        <li><a href="<?php echo APP_URL; ?>testimony/" class="active">Testimonios</a></li>
                    </ul>
                </li>
                <li><a href="<?php echo APP_URL; ?>services/">Servicios</a></li>
                <li><a href="<?php echo APP_URL; ?>portfolio">portafolio</a></li>
