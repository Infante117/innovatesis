...
protected function insertarServicio($datos) {
    try {
        $conexion = $this->conectar();    
        ...
        $sql = "CALL Procedimiento_InsertarServicio($parametros)";
...
protected function UpdateServices($datos) {
    try {
        $conexion = $this->conectar();    
        // Crear la cadena de marcadores de posición para los parámetros
        $parametros = rtrim(str_repeat('?, ', count($datos)), ', ');    
        // Crear la cadena de llamada al procedimiento almacenado con marcadores de posición
        $sql = "CALL Procedimiento_ActualizarServicio($parametros)";
        // Depuración: imprimir SQL generado
        // echo $sql;
        $query_sql = $conexion->prepare($sql);    
        // Ejecutar el procedimiento almacenado con los valores de los parámetros
...
protected function BajaServices($datos) {
    try {
        $conexion = $this->conectar();    
        // Crear la cadena de marcadores de posición para los parámetros
        $parametros = rtrim(str_repeat('?, ', count($datos)), ', ');    
        // Crear la cadena de llamada al procedimiento almacenado con marcadores de posición
        $sql = "CALL Procedimiento_DarBajaServicio($parametros)";
        // Depuración: imprimir SQL generado
        // echo $sql;
        $query_sql = $conexion->prepare($sql);    
        // Ejecutar el procedimiento almacenado con los valores de los parámetros
...
protected function AltaServices($datos) {
    try {
        $conexion = $this->conectar();    
        // Crear la cadena de marcadores de posición para los parámetros
        $parametros = rtrim(str_repeat('?, ', count($datos)), ', ');    
        // Crear la cadena de llamada al procedimiento almacenado con marcadores de posición
        $sql = "CALL Procedimiento_DarAltaServicio($parametros)";
        // Depuración: imprimir SQL generado
        // echo $sql;
        $query_sql = $conexion->prepare($sql);    
        // Ejecutar el procedimiento almacenado con los valores de los parámetros
