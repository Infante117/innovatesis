<?php
	...
	class mainModel{
		...
		protected function actualizarRoles($datos){
			try {
				...
				$sql = "CALL Procedimiento_ActualizarRol($parametros)";
		...
		protected function darBajaRol($datos){
			try {
				$conexion = $this->conectar();    
				// Crear la cadena de marcadores de posición para los parámetros
				$parametros = rtrim(str_repeat('?, ', count($datos)), ', ');    
				// Crear la cadena de llamada al procedimiento almacenado con marcadores de posición
				$sql = "CALL Procedimiento_BajaRol($parametros)";
				// Depuración: imprimir SQL generado
				// echo $sql;
				$query_sql = $conexion->prepare($sql);    
				// Ejecutar el procedimiento almacenado con los valores de los parámetros
		...
		protected function restablecerRol($datos){
			try {
				$conexion = $this->conectar();    
				// Crear la cadena de marcadores de posición para los parámetros
				$parametros = rtrim(str_repeat('?, ', count($datos)), ', ');    
				// Crear la cadena de llamada al procedimiento almacenado con marcadores de posición
				$sql = "CALL Procedimiento_AltaRol($parametros)";
				// Depuración: imprimir SQL generado
				// echo $sql;
				$query_sql = $conexion->prepare($sql);    
				// Ejecutar el procedimiento almacenado con los valores de los parámetros
		...
		protected function registrarRoles($datos){
			try {
				$conexion = $this->conectar();    
				// Crear la cadena de marcadores de posición para los parámetros
				$parametros = rtrim(str_repeat('?, ', count($datos)), ', ');    
				// Crear la cadena de llamada al procedimiento almacenado con marcadores de posición
				$sql = "CALL Procedimiento_RegistrarRol($parametros)";
				// Depuración: imprimir SQL generado
				// echo $sql;
				$query_sql = $conexion->prepare($sql);    
				// Ejecutar el procedimiento almacenado con los valores de los parámetros
